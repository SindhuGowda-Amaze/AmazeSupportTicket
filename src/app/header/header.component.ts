...
export class HeaderComponent implements OnInit {
  ...
  //   debugger
  //   this.unseen = 0;
  //   this.AmazeSupportService.GetNotification(sessionStorage.getItem('EmaployedID')).subscribe(data => {
  //     debugger
  ...
  //   debugger
  //   this.AmazeSupportService.ClearNotificationByID(sessionStorage.getItem('EmaployedID')).subscribe(data => {
  //     debugger
  ...
  //     "Seen": 1
  //   }
  //   this.AmazeSupportService.UpdateNotificationSeen(entity).subscribe(data => {
  //     debugger
  //     this.GetNotification();
  //   })
   }
